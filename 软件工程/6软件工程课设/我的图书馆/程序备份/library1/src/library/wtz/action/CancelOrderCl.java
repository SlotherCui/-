...
public class CancelOrderCl extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String bookState=ToolString.getNewString(request.getParameter("bookState"));
		System.out.println("bookState:"+bookState);
		new User().cancelOrder(bookId, bookState);
